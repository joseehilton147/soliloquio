						...
						<div className="relative space-y-4">
							...
							<div className="flex gap-3">
								...
								<p className="text-sm text-indigo-200/80 leading-relaxed">
									<span className="font-semibold text-indigo-300">As ate 10</span> — A jornada
									numerica da manifestacao. Cada numero representa um estagio evolutivo
									da energia do naipe, desde o potencial puro (As) ate a completude (10).
								</p>
							</div>
						</div>
					</div>

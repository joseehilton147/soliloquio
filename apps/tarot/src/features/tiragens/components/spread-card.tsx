...
export function SpreadCard({ spread, showPreview = true, className }: SpreadCardProps) {
	const getCategoryInfo = () => {
		...
		> = {
			quick: { label: 'Rapida', color: 'from-green-600 to-emerald-600', icon: 'lucide:zap' },
			...
			decision: { label: 'Decisao', color: 'from-amber-600 to-orange-600', icon: 'lucide:git-fork' },

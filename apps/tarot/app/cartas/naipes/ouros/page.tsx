...
import { Sparkles, Layers, Star, BookOpen, Eye, Coins, Square } from 'lucide-react'
				...
				<div className="text-center space-y-8">
					...
					<div className="relative inline-flex items-center justify-center">
						<div className="absolute size-24 animate-spin-slow [animation-duration:12s]">
							<Square className="size-full text-yellow-500/20" strokeWidth={0.5} />
						</div>
					...
					<>
						...
						<div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
							{ouros.map((card: any) => (
								...
								>
									...
									{/* Card Image */}
									<div className="relative aspect-[2/3] w-full overflow-hidden bg-gradient-to-br from-yellow-900/20 via-amber-900/20 to-orange-900/20">
										{card.imageUrl ? (
											<>
												<Image
													src={card.imageUrl}
											...
											<div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
												{card.astrology && (
													<div className="flex items-center gap-1.5">
														<Star className="size-3 text-yellow-500/70 fill-yellow-500/20" />
						...
						<div className="relative py-12">
							...
							<div className="flex items-center justify-center gap-6 text-muted-foreground/30">
								<Coins className="size-5" strokeWidth={1} />

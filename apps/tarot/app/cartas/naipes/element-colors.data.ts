...
export const ELEMENT_COLORS = {
	...
	terra: {
		...
		nebula: 'from-yellow-900/20 via-yellow-950/10',
		circles: [
			'border-yellow-500/5',
			'border-amber-500/10',
		...
		energy1: 'from-yellow-600/10 via-amber-600/5',
		energy2: 'from-amber-600/10 via-yellow-600/5',
		particles: 'bg-yellow-400/40',
		symbols: ['text-yellow-500', 'text-amber-500', 'text-orange-500', 'text-yellow-500'],
		triangle: 'text-yellow-500/20',
		...
		divider: 'via-yellow-500/30',
		dividerIcon: 'text-yellow-400/50',
		breadcrumbSeparator: 'text-yellow-500/50',
		breadcrumbHover: 'hover:text-yellow-600 dark:hover:text-yellow-400',
		cardHover: 'hover:shadow-yellow-500/10 hover:border-yellow-500/30',
		cardBg: 'from-yellow-900/20 via-amber-900/20 to-orange-900/20',
	},
	ar: {
		name: 'Espadas',
		element: 'Ar',

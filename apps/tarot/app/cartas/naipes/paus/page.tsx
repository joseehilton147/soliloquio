				...
				<div className="text-center space-y-8">
					...
					<div className="relative inline-flex items-center justify-center">
						<div className="absolute size-24 animate-spin-slow [animation-duration:8s]">
							<Icon icon="lucide:triangle" className="size-full text-green-500/20" />
						</div>
						...
						<div className="space-y-6">
							<div className="flex items-start gap-4">
								<div className="inline-flex items-center justify-center size-14 rounded-full bg-gradient-to-br from-green-600/20 to-emerald-600/20 border-2 border-green-500/30 flex-shrink-0">
									<Icon icon="lucide:flame" className="size-7 text-green-600 dark:text-green-400" />
								</div>
					...
					<>
						...
						<div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
							{paus.map((card: any) => (
								...
								>
									...
									{/* Card Image */}
									<div className="relative aspect-[3/4] w-full overflow-hidden bg-gradient-to-br from-green-900/20 via-emerald-900/20 to-lime-900/20">
										{card.imageUrl ? (
											<>
												<Image
													src={card.imageUrl}
											...
											<div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
												{card.astrology && (
													<div className="flex items-center gap-1.5">
														<Icon icon="lucide:star" className="size-3 text-green-500/70" />
						...
						<div className="relative py-12">
							...
							<div className="flex items-center justify-center gap-6 text-muted-foreground/30">
								<Icon icon="lucide:flame" className="size-5" strokeWidth={1} />

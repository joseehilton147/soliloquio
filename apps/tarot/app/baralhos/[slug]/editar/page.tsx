...
export default function EditarBaralhoPage({ params }: PageProps) {
	...
	useEffect(() => {
		if (deck) {
			...
			setYear(deck.year ? deck.year.toString() : '')
			setTradition(deck.tradition || '')
		}
	}, [deck])
			...
			<form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-[380px_1fr]">
				...
				<div className="lg:sticky lg:top-24 lg:self-start space-y-4">
					...
					<div className="rounded-xl border-2 border-purple-500/30 bg-gradient-to-br from-purple-500/10 via-violet-500/10 to-indigo-500/10 p-5 backdrop-blur-sm shadow-lg shadow-purple-500/10">
						...
						{imageUrl ? (
							<div className="group relative aspect-square w-full rounded-lg overflow-hidden border-2 border-border/40 shadow-xl hover:shadow-purple-500/20 transition-all duration-300">
